...
const TechBadge = ({ tech }) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-white/[0.03] rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300 cursor-default">
      <div className="relative flex items-center gap-1.5 md:gap-2">
        <Icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-zinc-300 group-hover:text-white transition-colors" />
...
const FeatureItem = ({ feature }) => {
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/[0.03] transition-all duration-300 border border-transparent hover:border-white/10">
      ...
      <span className="text-sm md:text-base text-zinc-300 group-hover:text-white transition-colors font-light">
        {feature}
      </span>
    </li>
  );
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#0a0a0f] border border-white/10 rounded-xl overflow-hidden relative shadow-lg">
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/[0.03] p-2 md:p-3 rounded-lg border border-white/10 transition-all duration-300 hover:border-white/20">
        <div className="bg-white/10 p-1.5 md:p-2 rounded-full">
          <Code2 className="text-white w-4 h-4 md:w-5 md:h-5" strokeWidth={1.5} />
        </div>
        <div className="flex-grow">
          <div className="text-lg md:text-xl font-semibold text-white font-mono">{techStackCount}</div>
          <div className="text-[10px] md:text-xs text-zinc-400">Total Teknologi</div>
        </div>
      </div>

      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/[0.03] p-2 md:p-3 rounded-lg border border-white/10 transition-all duration-300 hover:border-white/20">
        <div className="bg-white/10 p-1.5 md:p-2 rounded-full">
          <Layers className="text-white w-4 h-4 md:w-5 md:h-5" strokeWidth={1.5} />
        </div>
        <div className="flex-grow">
          <div className="text-lg md:text-xl font-semibold text-white font-mono">{featuresCount}</div>
          <div className="text-[10px] md:text-xs text-zinc-400">Fitur Utama</div>
        </div>
      </div>
    </div>
  );
...
const ProjectDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030305] px-[2%] sm:px-0 relative overflow-hidden">
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          <div className="flex items-center space-x-2 md:space-x-4 mb-8 md:mb-12 animate-fadeIn">
            <button
              onClick={() => navigate(-1)}
              className="group inline-flex items-center space-x-1.5 md:space-x-2 px-3 md:px-5 py-2 md:py-2.5 bg-white/[0.04] backdrop-blur-xl rounded-xl text-zinc-200 hover:bg-white/[0.08] hover:text-white transition-all duration-300 border border-white/10 hover:border-white/20 text-sm md:text-base"
            >
              <ArrowLeft className="w-4 h-4 md:w-5 md:h-5 group-hover:-translate-x-1 transition-transform" />
              <span>Back</span>
            </button>
            <div className="flex items-center space-x-1 md:space-x-2 text-sm md:text-base text-zinc-500">
              <span>Projects</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-r from-white via-zinc-200 to-zinc-400 bg-clip-text text-transparent leading-tight" style={{ fontFamily: "'Space Grotesk', 'Poppins', sans-serif" }}>
                  {project.Title}
                </h1>
              ...
              {project.AdminInfo && (
                <div className="p-4 md:p-5 rounded-2xl bg-white/[0.02] border border-white/10 backdrop-blur-xl space-y-3 relative overflow-hidden group hover:border-white/20 transition-colors duration-300 animate-fadeIn">
                  <div className="flex items-center gap-2.5 text-zinc-200 font-semibold">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-sm">
                    <div className="bg-[#0a0a0f] p-3 rounded-xl border border-white/10 flex flex-col justify-center">
                      <span className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold">Admin Panel Link</span>
                      <a 
                        href={project.AdminInfo.Link} 
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="text-white hover:underline font-medium inline-flex items-center gap-1.5 transition-colors mt-1 text-xs sm:text-sm"
                      >
                        Go to Admin Panel <ExternalLink className="w-3.5 h-3.5" />
                      </a>
                    </div>
                    <div className="bg-[#0a0a0f] p-3 rounded-xl border border-white/10 flex flex-col justify-center">
                      <span className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold">Login Credentials</span>
                      <div className="text-zinc-300 mt-1 flex flex-wrap items-center gap-1 text-xs sm:text-sm">
                        <span>User:</span>
                        <code className="bg-white/10 text-white px-1.5 py-0.5 rounded font-mono font-bold">{project.AdminInfo.Username}</code>
                        <span className="mx-1">|</span>
                        <span>Pass:</span>
                        <code className="bg-white/10 text-white px-1.5 py-0.5 rounded font-mono font-bold">{project.AdminInfo.Password}</code>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black font-semibold rounded-xl transition-all duration-300 hover:bg-zinc-200 hover:scale-105 active:scale-95 shadow-[0_4px_20px_rgba(255,255,255,0.15)] text-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white/[0.04] text-zinc-200 hover:text-white hover:bg-white/[0.08] font-medium rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 border border-white/10 hover:border-white/20 text-sm"
