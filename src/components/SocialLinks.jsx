  ...
  const [socialLinks, setSocialLinks] = useState([
    {
      ...
      subText: "on LinkedIn",
      icon: Linkedin,
      url: "https://www.linkedin.com/in/san-project-41a03029b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
      color: "#0A66C2",
    ...
    },
    {
      ...
      subText: "@sannn.io",
      icon: Instagram,
      url: "https://www.instagram.com/sannn.io",
      color: "#E4405F",
    ...
    },
    {
      ...
      subText: "@sanproject",
      icon: Youtube,
      url: "https://www.youtube.com/@sannnnn_project",
      color: "#FF0000",
    ...
    },
    {
      ...
      subText: "@achsan490",
      icon: Github,
      url: "https://github.com/achsan490",
      color: "#ffffff",
    ...
    },
    {
      ...
      url: "https://www.tiktok.com/@sann.io",
      color: "black",
    ...
    },
    {
      ...
      subText: "achsanul.khuluq...",
      icon: Mail,
      url: "mailto:achsanul.khuluq.izzulchaq@gmail.com",
      color: "#EA4335",
    ...
    const fetchProfile = async () => {
      ...
      try {
        const { data, error } = await supabase
          ...
          .select('linkedin_connect, instagram_connect, youtube_connect, github_connect, tiktok_connect, whatsapp_connect')
          .eq('id', 1)
          .single();
        ...
        if (data) {
          setSocialLinks(prev => prev.map(link => {
            switch (link.name) {
              ...
              case 'WhatsApp':
                return data.whatsapp_connect ? { ...link, url: data.whatsapp_connect } : link;
              case 'Instagram':
