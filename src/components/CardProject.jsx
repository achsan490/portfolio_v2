  ...
  return (
    <div className="group relative w-full h-[400px] overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 shadow-xl">
      ...
      {Img && !imageError ? (
        ...
        <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-blue-900/50 via-blue-950/50 to-blue-950/50 flex items-center justify-center">
          ...
          <div className="flex items-center gap-3 opacity-0 group-hover:opacity-100 transition-all duration-300">
            {ProjectLink ? (
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-sm font-semibold rounded-lg transition-all duration-200 hover:scale-105"
              >
