		...
		<div className="fixed inset-0 ">
			<div className="absolute inset-0">
				<div
					...
					className="absolute top-0 -left-4 md:w-96 md:h-96 w-72 h-72 bg-blue-600 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 md:opacity-20 "></div>
				<div
			...
			<div className="absolute inset-0 bg-[linear-gradient(to_right,#2563eb10_1px,transparent_1px),linear-gradient(to_bottom,#2563eb10_1px,transparent_1px)] bg-[size:24px_24px]"></div>
		</div>
	)
}
