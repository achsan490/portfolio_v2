    ...
    <AdminLayout activePage="certificates">
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg transition-all shadow-lg hover:shadow-xl"
          >
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-[#020617] border border-white/10 rounded-xl w-full max-w-md my-8 max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-2 p-1 bg-white/5 rounded-lg">
                  <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-md transition-all ${uploadMethod === 'url'
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-md transition-all ${uploadMethod === 'file'
                      ? 'bg-blue-600 text-white'
                      : 'text-gray-400 hover:text-white'
                      }`}
                  >
              ...
              <div className="flex gap-3 p-6 border-t border-white/10 bg-[#020617] flex-shrink-0">
                <button
                  type="button"
                  onClick={handleCloseModal}
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg transition-all disabled:opacity-50"
                >
