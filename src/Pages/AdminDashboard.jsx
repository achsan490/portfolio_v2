      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <button
            ...
            className="p-6 bg-gradient-to-br from-cyan-500/10 to-cyan-600/10 border border-cyan-500/30 rounded-xl hover:from-cyan-500/20 hover:to-cyan-600/20 transition-all text-left group"
          >
