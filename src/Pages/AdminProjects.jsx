    ...
    <AdminLayout activePage="projects">
            ...
            {filteredProjects.map((project) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {project.category && (
                    <div className="mb-3">
                      <span className={`px-3 py-1 text-xs rounded-full font-medium ${project.category === 'Project' ? 'bg-cyan-500/20 text-cyan-300' :
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-[#020617] border border-white/10 rounded-xl w-full max-w-3xl my-8">
